...
public class LoggingFilter {
	...
	public static void logRequest(Request request, Response response) {
		String body = "";
		if (request.contentType() != null && request.contentType().equals(CONTENT_TYPE_APPLICATION_JSON)) {
	...
	public static void logResponse(Request request, Response response) {
		String body = "";
		if (response.type() != null && response.type().equals(CONTENT_TYPE_APPLICATION_JSON)) {
